...
public class SortCamelCase2 {
	...
	public static void cameLSortEfficient(StringBuilder sb, int n) {
...
System.out.println("===string===="+sb.toString());
	...
	public static void camelSort(StringBuilder sb, int n) {
		...
		for (int k = 0; k < n; k++) {
			...
			// Else pick the uppercase character
			else if (sb.charAt(k) >= 'A' && sb.charAt(k) <= 'Z') {
				sb.setCharAt(k, upper.elementAt(j));
				++j;
			}
		}
	...
	public static void main(String[] args) {
		...
		cameLSortEfficient(sb, sb.length());
	}
